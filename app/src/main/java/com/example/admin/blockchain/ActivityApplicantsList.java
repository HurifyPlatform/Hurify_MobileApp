...
import com.example.admin.blockchain.helper.ProjectAppliedInfoAdapter;
...
public class ActivityApplicantsList extends AppCompatActivity {
      ...
      /*  recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this.getApplicationContext(), recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ProjectAppliedInfoModel model = modelList.get(position);
                 ...
                 intent.putExtra("project_id",data);
    ...
    private void AppliedAppliedUserList(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://platform.hurify.co/project/getappliedusers", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                response= "{\"success\":1,\"message\":[{\"id\":35,\"appliers_email\":\"ashish@mobodexter.com\",\"project_id\":24,\"bid_value\":56,\"experience_level\":\"Beginner\",\"days\":7,\"status\":\"DevEvaluation\",\"type\":\"Select\"},{\"id\":36,\"appliers_email\":\"mohit.sha@mobodexter.com\",\"project_id\":24,\"bid_value\":56,\"experience_level\":\"Beginner\",\"days\":7,\"status\":\"Submitted\",\"type\":\"Selected\"}]}";
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i=0;i<jsonArray.length();i++){
                            ...
                            ProjectAppliedInfoModel model=new ProjectAppliedInfoModel(id,ProjectName,DayValue,BidValue,ExpertLevel,Type,Status);
                            modelList.add(model);
                            //Log.d("listt",modelList+"");
