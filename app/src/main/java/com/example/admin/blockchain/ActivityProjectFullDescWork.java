...
public class ActivityProjectFullDescWork extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_full_desc_work);
        init();
        profileShowHire();
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.Apply) {
            ...
            Intent intent = new Intent(ActivityProjectFullDescWork.this,ActivityApplicantsList.class);
