...
public class ActivityApplicantsProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    String email,name,country,language,jobtitle,hourrate,category,skills,overview,exp,data,projectID;
    String TAG="tag";
    ...
    private void Approve() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://platform.hurify.co/project/approve", new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Map<String, String> params = new HashMap<>();
               // params.put("appliers_email", name);
               // params.put("project_id", projectID);
               // params.put("seekers_email", data);
                Log.d("seekers_email", data);
                Log.d("appliers_email", name);
